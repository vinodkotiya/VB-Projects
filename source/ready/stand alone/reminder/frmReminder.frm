...
FileError:
    ...
    MsgBox "Unkown error while saving file " & "dates.vin"
End Sub
...
FileError:
    ...
    & " ''data\date.vin'' in the application's default folder"
End Sub
...
If optText.Value = True Then
 ...
 cmdPlay.Enabled = False
 RichTextBox1.Enabled = True
  cmdOk.Caption = "OK Remind Me Later by above Text Message"
End If
End Sub
...
Private Sub smnabout_Click()
 MsgBox "Created on march 2003 " & vbCrLf & _
   "programmer VINOD KOTIYA " & vbCrLf & _
  "web: http:\\vinodkotiya.tripod.com" & vbCrLf & _
  "mail: vinodkotiya@yahoo.co.in"
End Sub

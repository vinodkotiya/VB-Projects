...
FileError:
  '  If Err.Number = cdlCancel Then Exit Sub
    MsgBox "Unkown error while opening file " & "loadrem.vin" _
     & "To eliminate problem Open vin utility " _
     & "Click on troubleshooting and restore all data files of this software "
...
FileError:
  '  If Err.Number = cdlCancel Then Exit Sub
    MsgBox "Unkown error while opening file data\dates.vin or message text file or fails to playback" & "" _
     & "The file may not exist on your harddrive. To eliminate this problem click Troubleshoot on vin utility kit"
      Close InFile
   ' OpenFile = ""

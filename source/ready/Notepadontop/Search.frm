...
End If
Position = InStr(Position + 1, Form1.Editor.Text, Text1.Text, compare)
If Position > 0 Then
    ReplaceButton.Enabled = True
    ReplaceAllButton.Enabled = True
    Form1.Editor.SelStart = Position - 1
    Form1.Editor.SelLength = Len(Text1.Text)
    Form1.SetFocus
Else
...
Dim compare As Integer
    ...
    Form1.Editor.SelText = Text2.Text
    If Check1.Value = 1 Then
        compare = vbBinaryCompare
    Else
        compare = vbTextCompare
...
Dim compare As Integer
    ...
    While Position > 0
        ...
        Position = InStr(Position + 1, Form1.Editor.Text, Text1.Text)
    Wend
        ReplaceButton.Enabled = False
        ReplaceAllButton.Enabled = False

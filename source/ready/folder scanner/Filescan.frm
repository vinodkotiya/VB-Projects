...
Begin VB.Form frmAlbum 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "&Make"
      TabPicture(0)   =   "Filescan.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame4"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "&Settings"
      TabPicture(1)   =   "Filescan.frx":001C
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame Frame3 
            Caption         =   "Alternative Text when image not shown"
            Height          =   735
            Left            =   3480
            TabIndex        =   41
            Top             =   1080
         ...
         End
         Begin VB.Frame Frame2 
            Caption         =   "Also Display the following image information below the each image"
            Height          =   735
            Index           =   2
            Left            =   0
            TabIndex        =   39
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "   List of Valid Image Files"
            Height          =   255
            Index           =   2
            Left            =   120
            TabIndex        =   55
...
Dim imagesinrow As Integer         ' store total no of images in each row
Dim imagesinpage As Integer    ' store total no of images in each page
Dim PageNo  As Integer    ' store current no of pages
Dim imageWidth As Integer    ' store resolution  of images
Dim imageHeight As Integer     ' store resolution  of images
...
Private Const regKey = "\vinsoft\VIN WebAlbum Maker"
'tranceparent
...
lblStatus.Caption = "These extention determines the type of image files to be added on your WebAlbum at the time of scanning folders"
End Sub

Private Sub cmdNew_Click()
Dim txt As String
txt = InputBox("Enter new image extention to be added : " & vbCrLf & "  use ' * ' then ' . ' then 'extention' " & vbCrLf & "  eg.  ", "New Extention", "*.bmp")
...
On Error GoTo FileError
   ...
   Exit Sub
FileError:
    MsgBox "Unkown error while opening file " & "imext.vin" _
...
lblStatus.Caption = " If you wanna add more image file extentions then click here. " & _
"These extention determines the type of image files to be added on your WebAlbum at the time of scanning folders"
End Sub
...
If Trim(txtRes(0).Text) = "" Or Trim(txtRes(1).Text) = "" Then
  MsgBox "Check the resolution of each images"
  checkonce = False
ElseIf Trim(txtRes(3).Text) = "" And optNo(0).Value = True Then
MsgBox "Check the no of images in  a Row "
    checkonce = False
 ...
 Else
     ...
     If optNo(0).Value = True Then imagesinrow = Val(txtRes(3).Text)
     imagesinpage = vscrollRes(2).Value
     checkonce = True
End If
End Function
...
PageNo = 1      'set new page for each folder
   ...
   i = InStr(1, Right(File1.Path, Len(File1.Path) - Len(firstFolder)), "\")
          ...
          Wend
   Upper (dEpth)       'fill txtbox with starting tags
...
For i = 0 To File1.ListCount - 1                 'scanning current folder
  'Text1.Text = Text1.Text & vbCrLf & File1.List(i)
     ...
     lblScan.Caption = " Scanning  folder " & thisfolder.Name & "  for file  " & File1.List(i)     'progress bar
     Label(1).Caption = "Files : " & totalFiles + i + 1 & "   Time : " & DateDiff("s", starttime, Now) & " Seconds"
      If optAlt(1).Value = True Then altText = File1.List(i)        'if user not give alternate text then use filename
       Set ThisFile = Fsys.GetFile(File1.Path & "\" & File1.List(i))             ' for file attributes
           ...
           '-----------------------making single cell for each image file
           txtScanned.Text = txtScanned.Text & "<td> <center><a href = " & Chr(34) & File1.List(i) & Chr(34) & "><img src = " & Chr(34) & File1.List(i) & Chr(34) & " align = center height = " & txtRes(1).Text & " width = " & txtRes(0).Text & " alt = " & altText & "  > </img><br><FONT size = 4>" & File1.List(i) & "</FONT></a><font size = 2 color =" & Chr(34) & hcodeTEXT & Chr(34) & ">"
         ...
         ''------------- 1 cell complete with image , name and information
            
        If (i + 1) Mod imagesinrow = 0 Then       'when 1 row com[plete switch to next row
              txtScanned.Text = txtScanned.Text & vbCrLf & "</tr><tr>"
       End If
       
       If (i + 1) Mod imagesinpage = 0 Then    'when 1 page complete
          txtScanned.Text = txtScanned.Text & "</tr></table></center> "
          If PageNo = 1 Then txtScanned.Text = txtScanned.Text & "<br><CENTER><FONT size = 6><A href=" & Chr(34) & thisfolder.Name & PageNo + 1 & ".html" & Chr(34) & "><B>NEXT -- >>>></B></A></font></center> "
          If PageNo > 1 Then txtScanned.Text = txtScanned.Text & "<br><CENTER><FONT size = 6><A href=" & Chr(34) & thisfolder.Name & PageNo - 1 & ".html" & Chr(34) & "><B> <<<< -- BACK  </B></A>&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; <A href=" & Chr(34) & thisfolder.Name & PageNo + 1 & ".html" & Chr(34) & "><B>NEXT -- >>>></B></A></font></center> <br><br>"
...
End Sub
Private Sub Upper(deep As Integer)
Dim v As Integer
...
"href= " & Chr(34) & dotDot & "about.html" & Chr(34) & "<B>ABOUT / Credit </B></A>&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href=" & Chr(34) & dotDot & "main.html" & Chr(34) & "><BIG> Go To Main Page  </BIG></A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;<A href=" & Chr(34) & "mailto:vinodkotiya24@rediffmail.com" & Chr(34) & "><B>Mail me</B></A>&nbsp;|&nbsp;<A " & _
"href= " & Chr(34) & "http://vinodkotiya.tripod.com" & Chr(34) & "><B>VINSOFT</B></A></font></center><hr>"

End Sub
Private Sub Lower(deep As Integer)
Dim v As Integer
Dim dotDot As String
dotDot = ""
For v = 1 To deep
...
txtScanned.Text = txtScanned.Text & "<br><hr> <center><font size = 2 color = " & Chr(34) & "#ffffff" & Chr(34) & " ><A href=" & Chr(34) & "http://vinodkotiya.tripod.com" & Chr(34) & "><B>http://vinodkotiya.tripod.com</B></A>&nbsp;|&nbsp;<A  " & _
"href= " & Chr(34) & dotDot & "about.html" & Chr(34) & "<B>ABOUT / Credit </B></A>&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href=" & Chr(34) & dotDot & "main.html" & Chr(34) & "><BIG> Go To Main Page  </BIG></A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;<A href=" & Chr(34) & "mailto:vinodkotiya24@rediffmail.com" & Chr(34) & "><B>Mail me</B></A>&nbsp;|&nbsp;<A " & _
"href= " & Chr(34) & "http://vinodkotiya.tripod.com" & Chr(34) & "><B>VINSOFT</B></A></font></center>"
End Sub
Sub MoveUp()
...
Dim v As Integer
Upper (0)
txtScanned.Text = txtScanned.Text & "<br><br><center> <font size = 5> WebAlbum Main Page </font></center><br><br>" & vbCrLf
...
lblStatus.Caption = "If size of each images are more then 50 KB or resolution above 800 X 600 then " & _
 " images per page should be less then 40 otherwise it will take too much time to load the webpage on 128 MB RAM " & _
 "But you can use more then 40 per page if images are of small size or small resolution."
End Sub

Private Sub Frame2_MouseMove(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
 If Index = 0 Then
   lblStatus.Caption = "Set the resolution of each images to be displayed on webAlbum as a link. You can rich to the original images by clicking on these links."
 ElseIf Index = 1 Then
   lblStatus.Caption = "Set the no of images to be displayed in each row or it is the no of columns.Click on default if you want default no of columns."
  ElseIf Index = 2 Then
  lblStatus.Caption = "Determines the which information should be displayed alongwith each image."
  ElseIf Index = 3 Then
 ...
 ElseIf Index = 4 Then
  lblStatus.Caption = "Determines the execution speed for scanning files. Turbo mode is recommended if images are more then 0.1 million."
 End If
End Sub

Private Sub Frame3_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
lblStatus.Caption = "When Browser is unable to load any image then an alternative text will be displayed inplace of image . You can type any alternative text here otherwise the Name of the image will be used as alternative text (Recommended.)"
End Sub
...
lblStatus.Caption = " Write click or click on green ball to set the Background color and Text color of the webpages which will contain the pictures"
End Sub
...
Private Sub Label1_MouseMove(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
 If Index = 2 Then lblStatus.Caption = "These extention determines the type of image files to be added on your WebAlbum at the time of scanning folders"
End Sub
...
If vscrollRes(Index).Value > vscrollRes(Index).Min And vscrollRes(Index).Value < vscrollRes(Index).Max Then
   ...
   If Index = 3 Then imagesinrow = vscrollRes(Index).Value
...
Dim bufSize As Long
    ...
    'Create key if already exist then open the key
    retValue = RegCreateKey(HKEY_LOCAL_MACHINE, regKey, keyID)
    MsgBox retValue
    If retValue = 0 Then
        'Create width
        ...
        'No value, set it
        If bufSize < 2 Then
            keyValue = vscrollRes(0).Value   ' Me.Width

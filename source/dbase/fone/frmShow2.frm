...
Begin VB.Form frmShow 
   ...
   Begin VB.TextBox txtRemarks 
      ...
      Left            =   240
      TabIndex        =   16
      Text            =   "Remarks:- Author of this program"
      Top             =   3360
      Width           =   8295
   End
   Begin VB.TextBox txtWeb 
      ...
      Left            =   240
      TabIndex        =   15
      Text            =   "Website:-http:\\vinsoftindia.tripod.com ; http:\\vinodkotiya.tripod.com"
      Top             =   3000
      Width           =   3975
   End
   ...
   Begin VB.TextBox txtEmail 
      ...
      Left            =   240
      TabIndex        =   1
      Text            =   "Emails:- vinner24@rediffmail.com "
      Top             =   2640
      Width           =   8295
   End

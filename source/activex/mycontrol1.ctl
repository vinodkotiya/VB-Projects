...
Public Sub MyMethod()
MsgBox "my control is in action  " & myproperty
End Sub

Public Property Get mybackcolor() As Variant
mybackcolor = Text1.BackColor
End Property

Public Property Let mybackcolor(ByVal vNewValue As Variant)
Text1.BackColor = vNewValue
PropertyChanged "mybackcolor"

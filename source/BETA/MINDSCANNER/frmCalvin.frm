...
txtLcd.Text = ""
Op = 1
ElseIf cmdSwitch.Caption = "On" Then
 If timFace.Interval > 10 Then
...
Lcd = 1
ElseIf Lcd > 130 Then
txtLcd.Text = "CLICK  '_'  FOR DECREASE SPEED"
Lcd = Lcd + 1
ElseIf Lcd > 110 Then
txtLcd.Text = " CLICK   '+'  FOR INCREASE SPEED"
Lcd = Lcd + 1
ElseIf Lcd > 90 Then
...
Lcd = Lcd + 1
ElseIf Lcd > 45 Then
txtLcd.Text = "COPYWRITE (c) 2002 VINOD KOTIYA"
Lcd = Lcd + 1
ElseIf Lcd > 30 Then
...
F = 1
End If
If (picCopy.Left + 11535) > 2000 Then
picCopy.Left = picCopy.Left - 90
Else  'If (picCopy.Left + 11535) > 120
picCopy.Left = 1800
End If
End Sub

...
'Rndm = Rnd(1000)
 ...
 ' Rndm = Rndm * 100
  'txtKey.Text = Str(Rndm)
  'If Rndm < 50 Then
  If side = "goRight" Then
   If (imgCar1.Left + imgCar1.Width) < (imgRoad1.Left + imgRoad1.Width) Then
    imgCar1.Left = imgCar1.Left + 40
    Else
    side = "goLeft"
    imgCar1.Left = imgCar1.Left - 40
    End If
  ElseIf side = "goLeft" Then
